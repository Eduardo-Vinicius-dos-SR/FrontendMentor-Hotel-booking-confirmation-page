...
export default function Button({ variant, onClick, children }: ButtonProps) {
    const base = "px-6 lg:px-5 2xl:px-3 py-2 rounded-4xl cursor-pointer whitespace-nowrap text-sm lg:text-xs 2xl:text-sm transition-colors duration-200 ease-in-out"
